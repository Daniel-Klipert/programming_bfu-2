...
set(__qt_CoreTools_should_include_targets_code "TRUE")

# Do the checks inside Targets.cmake even when the file is still being generated
if(__qt_CoreTools_should_include_targets_code)
    include("${CMAKE_CURRENT_LIST_DIR}/Qt6CoreToolsTargetsPrecheck.cmake")
endif()

if(NOT __qt_CoreTools_skip_include_targets_file
        AND Qt6CoreTools_FOUND
        AND __qt_CoreTools_should_include_targets_code
    )
    ...
    set(__qt_CoreTools_targets_file_included ON)
endif()

set(__qt_CoreTools_extra_cmake_includes "")
foreach(extra_cmake_include IN LISTS __qt_CoreTools_extra_cmake_includes)
    include("${CMAKE_CURRENT_LIST_DIR}/${extra_cmake_include}")
endforeach()


if(__qt_CoreTools_targets_file_included AND Qt6CoreTools_FOUND)
...
if(__qt_CoreTools_targets_file_included AND Qt6CoreTools_FOUND)
    __qt_internal_promote_target_to_global(Qt6::wasmdeployqt)
endif()
...
set(Qt6CoreToolsTools_TARGETS "Qt6::syncqt;Qt6::moc;Qt6::rcc;Qt6::tracepointgen;Qt6::tracegen;Qt6::cmake_automoc_parser;Qt6::qlalr;Qt6::qtpaths;Qt6::androiddeployqt;Qt6::androidtestrunner;Qt6::wasmdeployqt;Qt6::windeployqt;Qt6::qmake")
