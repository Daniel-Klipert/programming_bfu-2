...
include("${CMAKE_CURRENT_LIST_DIR}/Qt6CoreTargetsPrecheck.cmake")

if(NOT __qt_Core_skip_include_targets_file AND Qt6Core_FOUND)
    ...
    include("${CMAKE_CURRENT_LIST_DIR}/Qt6CoreExtraProperties.cmake"
        OPTIONAL)
    set(__qt_Core_targets_file_included ON)
endif()

# Find the private module counterpart.
set(__qt_Core_always_load_private_module OFF)
...
if (Qt6Core_FOUND
    ...
    find_package(Qt6CorePrivate "6.12.0" EXACT
        QUIET
        CONFIG
        PATHS
...
if (TARGET Qt6::Core)
    ...
    foreach(extra_cmake_include Qt6CoreMacros.cmake;Qt6CoreTransitiveExtras.cmake;Qt6CoreConfigExtras.cmake)
    ...
    if(NOT DEFINED Qt6Core_NOT_FOUND_MESSAGE)
        ...
        if(__qt_Core_skip_include_targets_file)
            string(APPEND Qt6Core_NOT_FOUND_MESSAGE
                "Possibly due to __qt_Core_skip_include_targets_file being set to TRUE and thus "
