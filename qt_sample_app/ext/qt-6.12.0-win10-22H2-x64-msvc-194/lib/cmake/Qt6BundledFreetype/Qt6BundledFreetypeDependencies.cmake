...
set(__qt_BundledFreetype_third_party_package_WrapPNG_provided_targets "WrapPNG::WrapPNG")

if(__qt_BundledFreetype_third_party_deps)
    _qt_internal_find_third_party_dependencies("BundledFreetype" __qt_BundledFreetype_third_party_deps)
endif()
unset(__qt_BundledFreetype_third_party_deps)

# Find Qt tool package.
set(__qt_BundledFreetype_tool_deps "")
if(__qt_BundledFreetype_tool_deps)
    _qt_internal_find_tool_dependencies("BundledFreetype" __qt_BundledFreetype_tool_deps)
endif()
unset(__qt_BundledFreetype_tool_deps)

# note: target_deps example: "Qt6Core\;5.12.0;Qt6Gui\;5.12.0"
set(__qt_BundledFreetype_target_deps "Qt6Core\;6.12.0")
set(__qt_BundledFreetype_find_dependency_paths "${CMAKE_CURRENT_LIST_DIR}/.." "${_qt_cmake_dir}")
if(__qt_BundledFreetype_target_deps)
...
unset(__qt_BundledFreetype_target_deps)
unset(__qt_BundledFreetype_find_dependency_paths)
