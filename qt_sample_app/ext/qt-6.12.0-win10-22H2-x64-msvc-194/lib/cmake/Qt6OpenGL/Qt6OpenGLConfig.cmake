...
include("${CMAKE_CURRENT_LIST_DIR}/Qt6OpenGLTargetsPrecheck.cmake")

if(NOT __qt_OpenGL_skip_include_targets_file AND Qt6OpenGL_FOUND)
    ...
    include("${CMAKE_CURRENT_LIST_DIR}/Qt6OpenGLExtraProperties.cmake"
        OPTIONAL)
    set(__qt_OpenGL_targets_file_included ON)
endif()

# Find the private module counterpart.
set(__qt_OpenGL_always_load_private_module OFF)
...
if (Qt6OpenGL_FOUND
    ...
    find_package(Qt6OpenGLPrivate "6.12.0" EXACT
        QUIET
        CONFIG
        PATHS
...
if(__qt_OpenGL_targets_file_included)
    # DEPRECATED
...
if (TARGET Qt6::OpenGL)
    ...
    foreach(extra_cmake_include Qt6OpenGLTransitiveExtras.cmake)
    ...
    if(NOT DEFINED Qt6OpenGL_NOT_FOUND_MESSAGE)
        ...
        if(__qt_OpenGL_skip_include_targets_file)
            string(APPEND Qt6OpenGL_NOT_FOUND_MESSAGE
                "Possibly due to __qt_OpenGL_skip_include_targets_file being set to TRUE and thus "
