...
include("${CMAKE_CURRENT_LIST_DIR}/Qt6FbSupportPrivateTargetsPrecheck.cmake")

if(NOT __qt_FbSupportPrivate_skip_include_targets_file AND Qt6FbSupportPrivate_FOUND)
    ...
    include("${CMAKE_CURRENT_LIST_DIR}/Qt6FbSupportPrivateExtraProperties.cmake"
        OPTIONAL)
    set(__qt_FbSupportPrivate_targets_file_included ON)
endif()

# Find the private module counterpart.
set(__qt_FbSupportPrivate_always_load_private_module OFF)
...
if (Qt6FbSupportPrivate_FOUND
    ...
    find_package(Qt6FbSupportPrivatePrivate "6.12.0" EXACT
        QUIET
        CONFIG
        PATHS
...
if(__qt_FbSupportPrivate_targets_file_included)
    # DEPRECATED
...
if (TARGET Qt6::FbSupportPrivate)
    ...
    foreach(extra_cmake_include Qt6FbSupportPrivateTransitiveExtras.cmake)
    ...
    if(NOT DEFINED Qt6FbSupportPrivate_NOT_FOUND_MESSAGE)
        ...
        if(__qt_FbSupportPrivate_skip_include_targets_file)
            string(APPEND Qt6FbSupportPrivate_NOT_FOUND_MESSAGE
                "Possibly due to __qt_FbSupportPrivate_skip_include_targets_file being set to TRUE and thus "
