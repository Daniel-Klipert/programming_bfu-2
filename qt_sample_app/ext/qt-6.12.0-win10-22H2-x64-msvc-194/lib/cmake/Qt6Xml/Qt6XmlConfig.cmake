...
include("${CMAKE_CURRENT_LIST_DIR}/Qt6XmlTargetsPrecheck.cmake")

if(NOT __qt_Xml_skip_include_targets_file AND Qt6Xml_FOUND)
    ...
    include("${CMAKE_CURRENT_LIST_DIR}/Qt6XmlExtraProperties.cmake"
        OPTIONAL)
    set(__qt_Xml_targets_file_included ON)
endif()

# Find the private module counterpart.
set(__qt_Xml_always_load_private_module OFF)
...
if (Qt6Xml_FOUND
    ...
    find_package(Qt6XmlPrivate "6.12.0" EXACT
        QUIET
        CONFIG
        PATHS
...
if(__qt_Xml_targets_file_included)
    # DEPRECATED
...
if (TARGET Qt6::Xml)
    ...
    foreach(extra_cmake_include Qt6XmlTransitiveExtras.cmake)
    ...
    if(NOT DEFINED Qt6Xml_NOT_FOUND_MESSAGE)
        ...
        if(__qt_Xml_skip_include_targets_file)
            string(APPEND Qt6Xml_NOT_FOUND_MESSAGE
                "Possibly due to __qt_Xml_skip_include_targets_file being set to TRUE and thus "
