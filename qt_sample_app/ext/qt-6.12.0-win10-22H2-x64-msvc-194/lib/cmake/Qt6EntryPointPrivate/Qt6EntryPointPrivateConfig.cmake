...
include("${CMAKE_CURRENT_LIST_DIR}/Qt6EntryPointPrivateTargetsPrecheck.cmake")

if(NOT __qt_EntryPointPrivate_skip_include_targets_file AND Qt6EntryPointPrivate_FOUND)
    ...
    include("${CMAKE_CURRENT_LIST_DIR}/Qt6EntryPointPrivateExtraProperties.cmake"
        OPTIONAL)
    set(__qt_EntryPointPrivate_targets_file_included ON)
endif()

# Find the private module counterpart.
set(__qt_EntryPointPrivate_always_load_private_module OFF)
include("${CMAKE_CURRENT_LIST_DIR}/Qt6EntryPointPrivate-build.cmake" OPTIONAL)
if (Qt6EntryPointPrivate_FOUND
        AND NOT Qt6EntryPointPrivatePrivate_FOUND
        AND NOT TRUE
        AND (
            __qt_EntryPointPrivate_always_load_private_module
    ...
    find_package(Qt6EntryPointPrivatePrivate "6.12.0" EXACT
        QUIET
        CONFIG
        PATHS
    ...
    if(NOT Qt6EntryPointPrivatePrivate_FOUND)
        get_property(Qt6EntryPointPrivatePrivate_warning_shown GLOBAL PROPERTY
            Qt6EntryPointPrivatePrivate_warning_shown
        )
        if(NOT Qt6EntryPointPrivatePrivate_warning_shown)
            message(VERBOSE
                "The private module package 'Qt6EntryPointPrivatePrivate' "
                "could not be found. It possibly needs to be installed separately with your "
                "package manager."
            )
            set_property(GLOBAL PROPERTY
                Qt6EntryPointPrivatePrivate_warning_shown ON
            )
        endif()
    endif()
endif()
unset(__qt_EntryPointPrivate_always_load_private_module)

if(__qt_EntryPointPrivate_targets_file_included)
    # DEPRECATED
...
if (TARGET Qt6::EntryPointPrivate)
    ...
    foreach(extra_cmake_include Qt6EntryPointPrivateTransitiveExtras.cmake)
    ...
    if(NOT DEFINED Qt6EntryPointPrivate_NOT_FOUND_MESSAGE)
        ...
        if(__qt_EntryPointPrivate_skip_include_targets_file)
            string(APPEND Qt6EntryPointPrivate_NOT_FOUND_MESSAGE
                "Possibly due to __qt_EntryPointPrivate_skip_include_targets_file being set to TRUE and thus "
