...
include("${CMAKE_CURRENT_LIST_DIR}/Qt6WidgetsTargetsPrecheck.cmake")

if(NOT __qt_Widgets_skip_include_targets_file AND Qt6Widgets_FOUND)
    ...
    include("${CMAKE_CURRENT_LIST_DIR}/Qt6WidgetsExtraProperties.cmake"
        OPTIONAL)
    set(__qt_Widgets_targets_file_included ON)
endif()

# Find the private module counterpart.
set(__qt_Widgets_always_load_private_module OFF)
...
if (Qt6Widgets_FOUND
    ...
    find_package(Qt6WidgetsPrivate "6.12.0" EXACT
        QUIET
        CONFIG
        PATHS
...
if(__qt_Widgets_targets_file_included)
    # DEPRECATED
...
if (TARGET Qt6::Widgets)
    ...
    foreach(extra_cmake_include Qt6WidgetsMacros.cmake;Qt6WidgetsTransitiveExtras.cmake)
    ...
    if(NOT DEFINED Qt6Widgets_NOT_FOUND_MESSAGE)
        ...
        if(__qt_Widgets_skip_include_targets_file)
            string(APPEND Qt6Widgets_NOT_FOUND_MESSAGE
                "Possibly due to __qt_Widgets_skip_include_targets_file being set to TRUE and thus "
