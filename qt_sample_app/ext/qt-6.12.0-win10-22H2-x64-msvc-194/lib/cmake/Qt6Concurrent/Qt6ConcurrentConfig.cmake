...
include("${CMAKE_CURRENT_LIST_DIR}/Qt6ConcurrentTargetsPrecheck.cmake")

if(NOT __qt_Concurrent_skip_include_targets_file AND Qt6Concurrent_FOUND)
    ...
    include("${CMAKE_CURRENT_LIST_DIR}/Qt6ConcurrentExtraProperties.cmake"
        OPTIONAL)
    set(__qt_Concurrent_targets_file_included ON)
endif()

# Find the private module counterpart.
set(__qt_Concurrent_always_load_private_module OFF)
...
if (Qt6Concurrent_FOUND
    ...
    find_package(Qt6ConcurrentPrivate "6.12.0" EXACT
        QUIET
        CONFIG
        PATHS
...
if(__qt_Concurrent_targets_file_included)
    # DEPRECATED
...
if (TARGET Qt6::Concurrent)
    ...
    foreach(extra_cmake_include Qt6ConcurrentTransitiveExtras.cmake)
    ...
    if(NOT DEFINED Qt6Concurrent_NOT_FOUND_MESSAGE)
        ...
        if(__qt_Concurrent_skip_include_targets_file)
            string(APPEND Qt6Concurrent_NOT_FOUND_MESSAGE
                "Possibly due to __qt_Concurrent_skip_include_targets_file being set to TRUE and thus "
