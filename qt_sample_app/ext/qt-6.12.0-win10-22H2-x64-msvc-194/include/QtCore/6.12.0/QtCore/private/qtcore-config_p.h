#ifndef QT_FEATURES_Core_src_corelib_qtcore_config_p_h_H
#define QT_FEATURES_Core_src_corelib_qtcore_config_p_h_H
...
#define QT_FEATURE_windows_ioring 1
...
#endif // QT_FEATURES_Core_src_corelib_qtcore_config_p_h_H
