...
include("${CMAKE_CURRENT_LIST_DIR}/Qt6OpenGLWidgetsTargetsPrecheck.cmake")

if(NOT __qt_OpenGLWidgets_skip_include_targets_file AND Qt6OpenGLWidgets_FOUND)
    ...
    include("${CMAKE_CURRENT_LIST_DIR}/Qt6OpenGLWidgetsExtraProperties.cmake"
        OPTIONAL)
    set(__qt_OpenGLWidgets_targets_file_included ON)
endif()

# Find the private module counterpart.
set(__qt_OpenGLWidgets_always_load_private_module OFF)
...
if (Qt6OpenGLWidgets_FOUND
    ...
    find_package(Qt6OpenGLWidgetsPrivate "6.12.0" EXACT
        QUIET
        CONFIG
        PATHS
...
if(__qt_OpenGLWidgets_targets_file_included)
    # DEPRECATED
...
if (TARGET Qt6::OpenGLWidgets)
    ...
    foreach(extra_cmake_include Qt6OpenGLWidgetsTransitiveExtras.cmake)
    ...
    if(NOT DEFINED Qt6OpenGLWidgets_NOT_FOUND_MESSAGE)
        ...
        if(__qt_OpenGLWidgets_skip_include_targets_file)
            string(APPEND Qt6OpenGLWidgets_NOT_FOUND_MESSAGE
                "Possibly due to __qt_OpenGLWidgets_skip_include_targets_file being set to TRUE and thus "
