...
include("${CMAKE_CURRENT_LIST_DIR}/Qt6FreetypePrivateTargetsPrecheck.cmake")

if(NOT __qt_FreetypePrivate_skip_include_targets_file AND Qt6FreetypePrivate_FOUND)
    ...
    include("${CMAKE_CURRENT_LIST_DIR}/Qt6FreetypePrivateExtraProperties.cmake"
        OPTIONAL)
    set(__qt_FreetypePrivate_targets_file_included ON)
endif()

# Find the private module counterpart.
set(__qt_FreetypePrivate_always_load_private_module OFF)
include("${CMAKE_CURRENT_LIST_DIR}/Qt6FreetypePrivate-build.cmake" OPTIONAL)
if (Qt6FreetypePrivate_FOUND
        AND NOT Qt6FreetypePrivatePrivate_FOUND
        AND NOT TRUE
        AND (
            __qt_FreetypePrivate_always_load_private_module
    ...
    find_package(Qt6FreetypePrivatePrivate "6.12.0" EXACT
        QUIET
        CONFIG
        PATHS
    ...
    if(NOT Qt6FreetypePrivatePrivate_FOUND)
        get_property(Qt6FreetypePrivatePrivate_warning_shown GLOBAL PROPERTY
            Qt6FreetypePrivatePrivate_warning_shown
        )
        if(NOT Qt6FreetypePrivatePrivate_warning_shown)
            message(VERBOSE
                "The private module package 'Qt6FreetypePrivatePrivate' "
                "could not be found. It possibly needs to be installed separately with your "
                "package manager."
            )
            set_property(GLOBAL PROPERTY
                Qt6FreetypePrivatePrivate_warning_shown ON
            )
        endif()
    endif()
endif()
unset(__qt_FreetypePrivate_always_load_private_module)

if(__qt_FreetypePrivate_targets_file_included)
    # DEPRECATED
...
if (TARGET Qt6::FreetypePrivate)
    ...
    foreach(extra_cmake_include Qt6FreetypePrivateTransitiveExtras.cmake)
    ...
    if(NOT DEFINED Qt6FreetypePrivate_NOT_FOUND_MESSAGE)
        ...
        if(__qt_FreetypePrivate_skip_include_targets_file)
            string(APPEND Qt6FreetypePrivate_NOT_FOUND_MESSAGE
                "Possibly due to __qt_FreetypePrivate_skip_include_targets_file being set to TRUE and thus "
