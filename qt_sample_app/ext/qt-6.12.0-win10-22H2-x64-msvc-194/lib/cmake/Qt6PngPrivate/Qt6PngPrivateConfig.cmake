...
include("${CMAKE_CURRENT_LIST_DIR}/Qt6PngPrivateTargetsPrecheck.cmake")

if(NOT __qt_PngPrivate_skip_include_targets_file AND Qt6PngPrivate_FOUND)
    ...
    include("${CMAKE_CURRENT_LIST_DIR}/Qt6PngPrivateExtraProperties.cmake"
        OPTIONAL)
    set(__qt_PngPrivate_targets_file_included ON)
endif()
...
if (Qt6PngPrivate_FOUND
    ...
    find_package(Qt6PngPrivatePrivate "6.12.0" EXACT
        QUIET
        CONFIG
        PATHS
...
if(__qt_PngPrivate_targets_file_included)
    # DEPRECATED
...
if (TARGET Qt6::PngPrivate)
    ...
    foreach(extra_cmake_include Qt6PngPrivateTransitiveExtras.cmake)
    ...
    if(NOT DEFINED Qt6PngPrivate_NOT_FOUND_MESSAGE)
        ...
        if(__qt_PngPrivate_skip_include_targets_file)
            string(APPEND Qt6PngPrivate_NOT_FOUND_MESSAGE
                "Possibly due to __qt_PngPrivate_skip_include_targets_file being set to TRUE and thus "
