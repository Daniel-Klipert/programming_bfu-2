...
include("${CMAKE_CURRENT_LIST_DIR}/Qt6GuiTargetsPrecheck.cmake")

if(NOT __qt_Gui_skip_include_targets_file AND Qt6Gui_FOUND)
    ...
    include("${CMAKE_CURRENT_LIST_DIR}/Qt6GuiExtraProperties.cmake"
        OPTIONAL)
    set(__qt_Gui_targets_file_included ON)
endif()

# Find the private module counterpart.
set(__qt_Gui_always_load_private_module OFF)
...
if (Qt6Gui_FOUND
    ...
    find_package(Qt6GuiPrivate "6.12.0" EXACT
        QUIET
        CONFIG
        PATHS
...
if(__qt_Gui_targets_file_included)
    # DEPRECATED
...
if (TARGET Qt6::Gui)
    ...
    foreach(extra_cmake_include Qt6GuiTransitiveExtras.cmake)
    ...
    if(NOT DEFINED Qt6Gui_NOT_FOUND_MESSAGE)
        ...
        if(__qt_Gui_skip_include_targets_file)
            string(APPEND Qt6Gui_NOT_FOUND_MESSAGE
                "Possibly due to __qt_Gui_skip_include_targets_file being set to TRUE and thus "
