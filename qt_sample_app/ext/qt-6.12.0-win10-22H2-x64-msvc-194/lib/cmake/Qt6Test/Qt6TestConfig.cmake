...
include("${CMAKE_CURRENT_LIST_DIR}/Qt6TestTargetsPrecheck.cmake")

if(NOT __qt_Test_skip_include_targets_file AND Qt6Test_FOUND)
    ...
    include("${CMAKE_CURRENT_LIST_DIR}/Qt6TestExtraProperties.cmake"
        OPTIONAL)
    set(__qt_Test_targets_file_included ON)
endif()

# Find the private module counterpart.
set(__qt_Test_always_load_private_module OFF)
...
if (Qt6Test_FOUND
    ...
    find_package(Qt6TestPrivate "6.12.0" EXACT
        QUIET
        CONFIG
        PATHS
...
if(__qt_Test_targets_file_included)
    # DEPRECATED
...
if (TARGET Qt6::Test)
    ...
    foreach(extra_cmake_include Qt6TestTransitiveExtras.cmake;QtTestProperties.cmake)
    ...
    if(NOT DEFINED Qt6Test_NOT_FOUND_MESSAGE)
        ...
        if(__qt_Test_skip_include_targets_file)
            string(APPEND Qt6Test_NOT_FOUND_MESSAGE
                "Possibly due to __qt_Test_skip_include_targets_file being set to TRUE and thus "
