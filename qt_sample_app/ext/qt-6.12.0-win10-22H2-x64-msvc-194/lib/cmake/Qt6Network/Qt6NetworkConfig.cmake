...
include("${CMAKE_CURRENT_LIST_DIR}/Qt6NetworkTargetsPrecheck.cmake")

if(NOT __qt_Network_skip_include_targets_file AND Qt6Network_FOUND)
    ...
    include("${CMAKE_CURRENT_LIST_DIR}/Qt6NetworkExtraProperties.cmake"
        OPTIONAL)
    set(__qt_Network_targets_file_included ON)
endif()
...
if (Qt6Network_FOUND
    ...
    find_package(Qt6NetworkPrivate "6.12.0" EXACT
        QUIET
        CONFIG
        PATHS
...
if(__qt_Network_targets_file_included)
    # DEPRECATED
...
if (TARGET Qt6::Network)
    ...
    foreach(extra_cmake_include Qt6NetworkTransitiveExtras.cmake)
    ...
    if(NOT DEFINED Qt6Network_NOT_FOUND_MESSAGE)
        ...
        if(__qt_Network_skip_include_targets_file)
            string(APPEND Qt6Network_NOT_FOUND_MESSAGE
                "Possibly due to __qt_Network_skip_include_targets_file being set to TRUE and thus "
