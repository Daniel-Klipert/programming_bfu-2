...
include("${CMAKE_CURRENT_LIST_DIR}/Qt6SqlTargetsPrecheck.cmake")

if(NOT __qt_Sql_skip_include_targets_file AND Qt6Sql_FOUND)
    ...
    include("${CMAKE_CURRENT_LIST_DIR}/Qt6SqlExtraProperties.cmake"
        OPTIONAL)
    set(__qt_Sql_targets_file_included ON)
endif()

# Find the private module counterpart.
set(__qt_Sql_always_load_private_module OFF)
...
if (Qt6Sql_FOUND
    ...
    find_package(Qt6SqlPrivate "6.12.0" EXACT
        QUIET
        CONFIG
        PATHS
...
if(__qt_Sql_targets_file_included)
    # DEPRECATED
...
if (TARGET Qt6::Sql)
    ...
    foreach(extra_cmake_include Qt6SqlTransitiveExtras.cmake)
    ...
    if(NOT DEFINED Qt6Sql_NOT_FOUND_MESSAGE)
        ...
        if(__qt_Sql_skip_include_targets_file)
            string(APPEND Qt6Sql_NOT_FOUND_MESSAGE
                "Possibly due to __qt_Sql_skip_include_targets_file being set to TRUE and thus "
