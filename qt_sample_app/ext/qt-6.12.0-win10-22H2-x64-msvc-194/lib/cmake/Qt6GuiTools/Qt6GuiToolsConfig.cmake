...
set(__qt_GuiTools_should_include_targets_code "TRUE")

# Do the checks inside Targets.cmake even when the file is still being generated
if(__qt_GuiTools_should_include_targets_code)
    include("${CMAKE_CURRENT_LIST_DIR}/Qt6GuiToolsTargetsPrecheck.cmake")
endif()

if(NOT __qt_GuiTools_skip_include_targets_file
        AND Qt6GuiTools_FOUND
        AND __qt_GuiTools_should_include_targets_code
    )
    ...
    set(__qt_GuiTools_targets_file_included ON)
endif()

set(__qt_GuiTools_extra_cmake_includes "")
foreach(extra_cmake_include IN LISTS __qt_GuiTools_extra_cmake_includes)
    include("${CMAKE_CURRENT_LIST_DIR}/${extra_cmake_include}")
endforeach()


if(__qt_GuiTools_targets_file_included AND Qt6GuiTools_FOUND)
    __qt_internal_promote_target_to_global(Qt6::qvkgen)
endif()
set(Qt6GuiToolsTools_TARGETS "Qt6::qvkgen")
