...
include("${CMAKE_CURRENT_LIST_DIR}/Qt6PrintSupportTargetsPrecheck.cmake")

if(NOT __qt_PrintSupport_skip_include_targets_file AND Qt6PrintSupport_FOUND)
    ...
    include("${CMAKE_CURRENT_LIST_DIR}/Qt6PrintSupportExtraProperties.cmake"
        OPTIONAL)
    set(__qt_PrintSupport_targets_file_included ON)
endif()

# Find the private module counterpart.
set(__qt_PrintSupport_always_load_private_module OFF)
...
if (Qt6PrintSupport_FOUND
    ...
    find_package(Qt6PrintSupportPrivate "6.12.0" EXACT
        QUIET
        CONFIG
        PATHS
...
if(__qt_PrintSupport_targets_file_included)
    # DEPRECATED
...
if (TARGET Qt6::PrintSupport)
    ...
    foreach(extra_cmake_include Qt6PrintSupportTransitiveExtras.cmake)
    ...
    if(NOT DEFINED Qt6PrintSupport_NOT_FOUND_MESSAGE)
        ...
        if(__qt_PrintSupport_skip_include_targets_file)
            string(APPEND Qt6PrintSupport_NOT_FOUND_MESSAGE
                "Possibly due to __qt_PrintSupport_skip_include_targets_file being set to TRUE and thus "
